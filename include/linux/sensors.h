...
/*daixiang add for algo-prox sensor_tp start*/
#define SENSOR_TYPE_SMARTPROX_TP 66555
#define SENSOR_TYPE_SMARTPROX_TP_HANDLE SENSORS_ACCELERATION_HANDLE
/*daixiang add for algo-prox sensor_tp end*/
